//--Author Alejandro Barraza-Valdez Feb. 22 2015 Combpton Analysis

#ifndef __TA2MyOwnPhysicsClass_h__
#define __TA2MyOwnPhysicsClass_h__
...
class TA2MyOwnPhysicsClass : public TA2Physics {
...
// Pi0Compton Class Variables
	...
	TA2MyOwnPhysicsClass(const char*, TA2Analysis*);
	virtual ~TA2MyOwnPhysicsClass();
